...
%data_dir = 'data/sift/Caltech101';       % directory for saving SIFT descriptors
%fea_dir = 'features/sift/Caltech101';    % directory for saving final image features

%img_dir = 'image/oxfordflower17';       % directory for the image database                             
%data_dir = 'data/sift/oxfordflower17';       % directory for saving SIFT descriptors
%fea_dir = 'features/sift/oxfordflower17';    % directory for saving final image features

%img_dir = 'image/SelfBuildFlower3';       % directory for the image database                             
