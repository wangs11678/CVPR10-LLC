...
data_dir = 'data/lbp/flower10';     % directory for saving HOG descriptors

% -------------------------------------------------------------------------
% extract HOG descriptors
exist_data_lbp = false;
if(exist_data_lbp)
    extr_lbp('F:\project\matlab\CVPR10-LLC\image\flower10','F:\project\matlab\CVPR10-LLC\data\lbp\flower10');
end
% -------------------------------------------------------------------------
